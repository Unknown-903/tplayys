...
class TG_CONFIG:
    ...
    bot_token = "7415012365:AAFwoKDevYPgYzHLJOG5OJ-2KSepJFFK-Gc"

    #DEVS or #OWNERS
    sudo_users = [1596559467, 7172796863, 6274275394, 1195351595, -1002233833025, -1002205027579, 5518437348, 1996570767, -1002230874428, 6651534688, 7011929837]
